...
<div class="col-md-8">
  <div class="profile-content">
    <div class="container">
      ...
      <form class="form-horizontal" action="index.php?createdesain" method="post" enctype="multipart/form-data">
       <input class="hidden" name="creatdesain" type="hidden"></input>

       <div class="form-group">
        <label class="align col-sm-2 control-label text-left" for="nama">Nama Bangunan: </label>
        <div class="col-sm-5">
          <input type="text" class="form-control" name="namaBangunan" placeholder="Masukkan Nama Bangunan">
        </div>
      </div>
