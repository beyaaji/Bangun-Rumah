      ...
      <div class="col-md-8">
        <div class="profile-content">
          <div class="container">
            ...
            <form class="form-horizontal" action="index.php?updatepdf" method="post" enctype="multipart/form-data">


              <input class="hidden" name="updatepdf" type="hidden"></input>
              <input class="hidden" name="idDesain" type="hidden" value="<?php echo $_GET['kirimpdf']; ?>" required>
           ...
           <div class="col-md-6">
            <div class="form-group">
            <label>pdf</label>
              <input type="file" class="form-control border-input" accept=".doc,.docx,.pdf" name="pdf">
            </div>
          </div>
        </div>
